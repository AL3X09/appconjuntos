...
import BasicElements from '@/components/BasicElementsSection.vue';
import Navigation from '@/components/Navigation.vue';
import TabsSection from '@/components/Tabs.vue';
import ProgressPagination from '@/components/ProgressPagination.vue';
import Notifications from '@/components/Notifications.vue';
import Typography from '@/components/Typography.vue';
import JavascriptComponents from '@/components/JavascriptComponents.vue';
import CarouselSection from '@/components/CarouselSection.vue';
import NucleoIconsSection from '@/components/NucleoIconsSection.vue';
